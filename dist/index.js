...
// Module
___CSS_LOADER_EXPORT___.push([module.id, `.re-container{
	width: 100%;
	height: 450px;
	position: relative;
}
...
.re-wrapper a{
	...
	left: 0;
	top: 0;
	background: transparent url(${___CSS_LOADER_URL_REPLACEMENT_0___}) no-repeat top left;
...
.re-container nav span{
	...
	height: 25px;
	opacity: 0.8;
	background: transparent url(${___CSS_LOADER_URL_REPLACEMENT_1___}) no-repeat top left;
}
